...
**3D point cloud** \[LiDAR frame\] &rarr; **2D projection** \[camera frame\]
...
1. convert each 3D LiDAR point &rarr; **homogeneous coordinates**
...
1. convert each 3D LiDAR point &rarr; **homogeneous coordinates**
2. apply **projection equations** \[translation/rotation\] 
  <br> &rarr; to convert from LiDAR to camera
...
[system of coordinates](https://en.wikipedia.org/wiki/Homogeneous_coordinates) $(x, y, w)$ &rarr; used in **projective** geometry
...
- coordinates &rarr; represented as **finite** coordinates 
...
- coordinates &rarr; represented as **finite** coordinates 
  <br> \[including points at **infinity**!\]
...
- coordinates &rarr; represented as **finite** coordinates 
  <br> \[including points at **infinity**!\]
- **simpler** formulas, more **symmetric**
- transformations &rarr; simple matrix multiplications
...
- **simpler** formulas, more **symmetric**
- transformations &rarr; simple matrix multiplications
  <br> \[rotation, scaling, translation, _etc._ \]
...
<img src="img/sensor_fusion_high/image23.png" height="600">
...
<img src="img/sensor_fusion_high/image22.png" height="500" width="1100">
<img src="img/sensor_fusion_high/image23.png" height="450">
...
- **step 1** &rarr; 3D obstacle detection \[**LiDAR**\]
- **step 2** &rarr; 3D obstacle detection \[**camera**\]
...
- **step 2** &rarr; 3D obstacle detection \[**camera**\] &rarr; **much harder**
  - deep learning + size/orientation of vehicles
  - IOU matching &rarr; bounding boxes overlap in 3D/2D
...
<img src="img/sensor_fusion_high/image28.png" width="1100">
...
<img src="img/sensor_fusion_high/image28.png" height="500">
<img src="img/sensor_fusion_high/image29.png" height="500">
...
- associate objects **in time**, from frame to frame
- also **predict next positions**
- bounding boxes **overlap** in consecutive frames &rarr; **same obstacle**
