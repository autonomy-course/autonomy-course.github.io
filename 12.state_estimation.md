...
Note:
- a moving average (rolling average or running average or moving mean or rolling mean) is a calculation to analyze data points by creating a series of averages of different selections of the full data set
...
(recall starting position, _prior_, &rarr; **equal likelhood** in any position)
