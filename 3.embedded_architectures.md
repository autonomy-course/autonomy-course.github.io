...
Note: 
- caps the minimum or maximum value that can be held in a fixed-point representation (e.g., moving audio knob past 100 &rarr; shouldn't "wrap around" to 0), 
...
most microprocessors **do not** include &rarr;  DSPs, ADCs, DACs, etc. 
