...
**matching** observed landmark from **different** scans is important!

---

consider a chair

<img src="img/slam/chair.jpg" width="900" border="1">
...
data association is **hard** to do **well**
...
- covariance matrix, $P$ &rarr; **uncertainty** and **correlations**,
...
- covariance matrix, $P$ &rarr; **uncertainty** and **correlations**,
    - diagnonal &rarr; variance (uncertainty) of individual landmarks
...
- covariance matrix, $P$ &rarr; **uncertainty** and **correlations**,
    - diagnonal &rarr; variance (uncertainty) of individual landmarks
    - off-diagonal &rarr; how error in landmark's position affects another
...
- covariance matrix, $P$ &rarr; **uncertainty** and **correlations**,
    - diagnonal &rarr; variance (uncertainty) of individual landmarks
    - off-diagonal &rarr; how error in landmark's position affects another
- **determinant** &rarr; "volume of uncertainty"

Note:
The determinant is a scalar value calculated from a square matrix that represents its scaling factor in linear transformations
...
- covariance matrix, $P$ &rarr; **uncertainty** and **correlations**,
    ...
    - off-diagonal &rarr; how error in landmark's position affects another
- **determinant** &rarr; "volume of uncertainty"
    - large &rarr; "cloud" of possible landmark positions is huge
...
- **determinant** &rarr; "volume of uncertainty"
    - large &rarr; "cloud" of possible landmark positions is huge
    - small &rarr; cloud is shrinking, closer to _exact_ coords

---

why does it "decrease monotonically"?

---

why does it "decrease monotonically"?

- adding new information with each step
...
- adding new information with each step
- EKF "discovers" how landmarks positioned w.r.t. **each other**
...
**note:** never goes down to $0$ &rarr; still some uncertainty
